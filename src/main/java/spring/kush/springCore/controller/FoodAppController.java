...
public class FoodAppController {
	...
	final FoodAppService foodAppService;
	...
	public ResponseEntity<ResponseDTO> createUser(@RequestBody FoodAppDTO foodAppDTO) {
		try {
			...
			return new ResponseEntity<>(new ResponseDTO(HttpStatus.BAD_REQUEST, "Food Item Saving Failed"),
	...
	public ResponseEntity<ResponseDTO> deleteFoodById(@PathVariable Long id) {
		try {
			...
			return new ResponseEntity<>(new ResponseDTO(HttpStatus.NOT_FOUND, "FOOD ID NOT FOUND."),
	...
	public ResponseEntity<ResponseDTO> updateFoodById(@PathVariable Long id, @RequestBody FoodAppDTO foodAppDTO) {
		try {
			...
			return new ResponseEntity<>(new ResponseDTO(HttpStatus.FORBIDDEN, "ERROR WHILE UPDATING FOOD ITEM"),
